...
/** The nav panel `path` registered in app.tsx; panel URLs are /plugins/tasks-plus/<PANEL_PATH>/<subPath>. */
...
/**
 * subPath grammar (the trailing route below /plugins/tasks-plus/tasks):
 *   ""                      → all tasks (default)
 *   "all"                   → all tasks
